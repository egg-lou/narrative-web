...
const Blog = () => {
  return (
    <div className='w-full bg-white py-8 px-2'>
      <h1 className='text-center font-bold text-4xl'>Narrative Reports</h1>
          <div className='container mx-auto py-8 px-8'>
            <div className='grid lg:grid-cols-4 gap-6 md:grid-cols-2 gap-2'>
              {cardList.map(card => (
                <div className='shadow-xl rounded-lg transform transition-transform hover:-translate-y-5 duration-200'>
                  <div className='p-5 bg-gray-300'>
                  <img src={card.img} alt="" style={{width: "400px", height: "200px"}} clas />
                  ...
                  <div className='flex justify-center pb-5 bg-gray-300'>
