...
//               {blogPost.img2 && <img src={blogPost.img2} alt='Img' className='img my-10 rounded-lg' />}
...
//               {blogPost.img3 && <img src={blogPost.img3} alt='Img' className='img my-10 rounded-lg' />}
...
//               {blogPost.img4 && <img src={blogPost.img4} alt='Img' className='img my-10 rounded-lg' />}
//             </div>
//           </div>
//         </div>
//       </div>
...
const LazyBlogPost = lazy(() => import('../components/LazyBlogPost'));
